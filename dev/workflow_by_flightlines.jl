...
outpath = "scratch/$(plots[plotnumber,:plot_ID])_res$(resolution)m_interpolationgrid_comptest_flightline$(flightlinenumber).jld2"
...
ray_aabb_intersection = Ray_AABB_intersection(ray, hcat(xyzi .- resolution, xyzi .+ resolution)')
